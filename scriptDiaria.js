 function ir() {
     ...
     var meta = 20
     var meta2 = 100 - ((acertos * 100) / meta)
     var meta3 = ((acertos * 100) / meta)
     var resto = ((80 - meta3) / 100) * 20
     ...
     if (meta3 < 80) {
        ...
        <div id="mensagem"><p> Em um total de 100%, você errou ${meta2}% das 20 questões.</br></br> Seu progresso foi de  ${meta3}%, porém a sua meta é de 80%. Sendo assim, a sua meta <strong>não foi alcançada</strong>. Dessa forma, para atingir o seu objetivo, você precisaria de mais ${80-meta3}%, ou seja , acertar mais ${resto} questões.</p></div>`
     } else {
         document.getElementById('barra').style = `width: 70%;height: 20px;border-radius:10px;border: thin solid  #2d2a3b; margin: auto; background: linear-gradient(to right, #558077 0%, #558077 ${meta3}%, #fbc7d4 0%)`
